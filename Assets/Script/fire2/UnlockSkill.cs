...
public class UnlockSkill : MonoBehaviour
{
    ...
    public GameObject lockImageSkill2;
    ...
    private string skill2Id = "skill_2";
    ...
    void Update()
    {
        ...
        {
            UnlockSkill1(skill1Id);
        }
    }

    void UnlockSkill1(string skillId)
    {
    ...
    public void UnlockSkill2(string skillId)
    {
        isSkill2Unlocked = true;
        UpdateFirebaseUnlockStatus(skillId, "unlocked");
        UpdateLockImageVisibility(lockImageSkill2, isSkill2Unlocked);
    }
    ...
    void SaveSkillUnlockStatusToPlayerPrefs()
    {
        ...
        PlayerPrefs.SetInt("skill2Status", isSkill2Unlocked ? 1 : 0);  // Lưu trạng thái mở khóa (1 = unlocked, 0 = locked)
